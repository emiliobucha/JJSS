                ...
                <form id="form1" runat="server">
                    ...
                    <asp:Panel ID="pnl_Inscripcion" CssClass="panel panel-default justify-content-center border rounded p-2" runat="server" Visible="true">
                        ...
                        <div class="row centered">
                            ...
                            <div class="col-md-3">
                                <asp:TextBox ID="txt_nombre" class="caja2" required="true" pattern="^[a-zA-ZñáéíóúÑÁÉÍÓÚ\s]+$" MaxLength="50" runat="server" placeholder="Ingrese nombre"></asp:TextBox>
                        ...
                        <div class="row centered">
                            ...
                            <div class="col-md-3">
                                <asp:TextBox ID="txt_apellido" required="true" MaxLength="50"  pattern="^[a-zA-ZñáéíóúÑÁÉÍÓÚ\s]+$" class="caja2" runat="server" placeholder="Ingrese apellido"></asp:TextBox>
