<%@ Page Title="" Language="C#" MasterPageFile="~/Presentacion/Site.Master" AutoEventWireup="true" CodeBehind="Menu_Evento.aspx.cs" Inherits="JJSS.Presentacion.Menu_Evento" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="cphContenido" runat="server">
    ...
    <form id="form1" runat="server">
        ...
        <div runat="server" class="container ">
            ...
            <div  runat="server" class="row  centered justify-content-center p-2">
                ...
                <!--Crear-->
                <div runat="server" class="col-sm-12 col-md-6 col-lg-2 col-xl-auto " id="crear_evento">
                    <a class="text-dark" href="CrearEvento.aspx">
                        <div class="btn " style="width: 10rem;">
                ...
                <div runat="server"  class="col-sm-12 col-md-6 col-lg-2 col-xl-auto " id="historial_evento">
                    <a class="text-dark" href="HistoricoEventos.aspx" id="historico_torneos">
                        <div class="btn " style="width: 10rem;">
                            ...
                            <div class="">
                                <h4 class="mb-5">Todos los Eventos</h4>
                            </div>
                        </div>
                    </a>
                </div>
