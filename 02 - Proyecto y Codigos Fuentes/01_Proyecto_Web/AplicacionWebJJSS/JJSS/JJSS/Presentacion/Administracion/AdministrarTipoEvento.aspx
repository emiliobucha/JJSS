<%@ Page Title="" Language="C#" MasterPageFile="~/Presentacion/Site.Master" AutoEventWireup="true" CodeBehind="AdministrarTipoEvento.aspx.cs" Inherits="JJSS.Presentacion.Administracion.AdministrarTipoEvento" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:Panel ID="pnlFormulario" runat="server">
            ...
            <div class="row centered justify-content-center">
                <h1 class=" centered ">Administrar Tipo de Evento</h1>
            </div>
            ...
            <div class="container">
                ...
                <div class="border rounded p-2">
                    <asp:GridView ID="gv_tipo_evento" runat="server" CssClass="table" CellPadding="4" DataKeyNames="id_tipo_evento" OnPageIndexChanging="gv_tipo_evento_PageIndexChanging"
                        ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" EmptyDataText="No hay tipos de evento para mostrar"
