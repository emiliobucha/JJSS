<%@ Page Title="" Language="C#" MasterPageFile="~/Presentacion/Site.Master" AutoEventWireup="true" CodeBehind="SobreNosotros.aspx.cs" Inherits="JJSS.Presentacion.SobreNosotros" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphContenido" runat="server">
    ...
    <div>
        <div class="row justify-content-center">
            ...
            <div class=" col-lg-4 col-md-12 col-sm-12 name">
                    <img class=" img-fluid p-2" src="../img/Mariano.jpg">
                    <p>MARIANO HINOJAL</p>
                    <div class="name-label"></div>
            </div>

            <div class="col col-lg-6 col-md-12 col-sm-12 name-desc">
                <div class=" p-2 ">
                    <h2>LOTUS CLUB                       
                        <br />
                        equipo HINOJAL</h2>
    ...
    &q=Dean Funes 705, Córdoba, Argentina" allowfullscreen>
                </iframe>
            </div>
