                            ...
                            <div class="form-group ">
                                ...
                                <asp:Panel ID="pnl_datos_personales" CssClass="panel panel-footer" runat="server">
                                    ...
                                    <div class="row centered">
                                        ...
                                        <div class="col-xs-3">
                                            <asp:TextBox ID="dp_fecha" runat="server" class="caja2" required="true" placeholder="Seleccione fecha "></asp:TextBox>
                                        </div>
                                ...
                                <!--Boton-->
                                <div class="row centered">
                                    <asp:Button ID="btn_cancelar" runat="server" formnovalidate="true" Text="Volver a inicio" CssClass="btn-link" CausesValidation="false" OnClick="btn_cancelar_Click" />
