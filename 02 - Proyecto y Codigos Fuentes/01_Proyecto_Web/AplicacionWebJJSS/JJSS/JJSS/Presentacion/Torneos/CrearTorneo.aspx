            ...
            <div class="container">
                <form id="form1" runat="server">
                    ...
                    <div class="form-group ">
                        <asp:Panel runat="server" CssClass="panel panel-default border rounded p-1">
...
<%--                                <div class="col col-1"><a class="text-danger">*</a></div>--%>
                        ...
                        <asp:LinkButton runat="server" ID="a" class="btn btn-link" Text="Volver" href="MenuTorneo.aspx"></asp:LinkButton>
                    </div>
