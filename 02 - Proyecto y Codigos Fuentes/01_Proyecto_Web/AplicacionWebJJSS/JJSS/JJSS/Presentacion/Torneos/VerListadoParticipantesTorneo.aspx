<%@ Page Language="C#" MasterPageFile="~/Presentacion/Site.Master" AutoEventWireup="true" CodeBehind="VerListadoParticipantesTorneo.aspx.cs" Inherits="JJSS.Presentacion.Torneos.VerListadoParticipantesTorneo" %>
                    ...
                    <div class="form-group border rounded p-4">
                        <asp:GridView ID="gv_participantes" runat="server" CssClass="table table-hover" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" EmptyDataText="No hay participantes para mostrar" AllowPaging="True" OnPageIndexChanging="gv_participantes_PageIndexChanging" PageSize="20">
                            <Columns>
                                ...
                                <asp:BoundField DataField="par_categoria" HeaderText="Categoría" />
                                <asp:BoundField DataField="par_faja" HeaderText="Faja" />
                                <asp:BoundField DataField="par_peso" HeaderText="Peso" />
