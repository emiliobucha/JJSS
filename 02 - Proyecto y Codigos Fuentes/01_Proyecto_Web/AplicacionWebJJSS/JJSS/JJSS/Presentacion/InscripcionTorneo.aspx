    ...
    <asp:Panel ID="pnlFormulario" runat="server" CssClass="justify-content-center">
        ...
        <div id="crearTorneowrap" >
            ...
            <form id="form1" runat="server" >
                ...
                <asp:Panel ID="pnl_elegirTorneo" CssClass="panel panel-default border" runat="server">
                ...
                <asp:Panel ID="pnl_InfoTorneo" CssClass="panel centered justify-content-center border" runat="server">
                ...
                <asp:Panel ID="pnl_dni" CssClass="panel panel-default border" runat="server" Visible="false">
                ...
                <asp:Panel ID="pnl_Inscripcion" CssClass="panel panel-default border" runat="server" Visible="false">
